...
FILES=/bigdata/faustmanlab/bch/gse53960/fastq/*.fastq.gz
...
do
    ...
    STAR --runThreadN 4 --genomeDir $index --readFilesIn $f --outSAMtype BAM SortedByCoordinate \
         --quantMode GeneCounts --readFilesCommand zcat --outFileNamePrefix /bigdata/faustmanlab/bch/gse53960/$base"_"
done
