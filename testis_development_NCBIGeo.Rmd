...
pacman::p_load(dplyr, DESeq2, plyranges, tidyverse, Glimma, try.bioconductor=TRUE)
...
ddsObject <- DESeq2::DESeqDataSetFromMatrix(countData = testis_counts,
                                            colData = metdata_testis, design = ~ time)
